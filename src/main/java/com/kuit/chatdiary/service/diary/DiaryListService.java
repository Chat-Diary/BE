...
public class DiaryListService {
     ...
     * */
    public List<DiaryListResponse> getDiaryWithPhotos(Long userId, LocalDate date){
        List<DiaryListResponse> diaries = diaryListRepository.inquiryDiary(userId, date);
    ...
    public List<DiaryListResponse> getMonthlyDiaryPhotos(Long userId, int year, int month){
        ...
        List<DiaryListResponse> diaries = diaryListRepository.inquiryDiaryRange(userId, firstDayOfMonth, lastDayOfMonth);
